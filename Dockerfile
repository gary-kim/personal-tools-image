...
RUN dnf install -y jq findutils rdfind hub rustc cargo openssl-devel make nodejs npm git patch gcc g++ python3-distutils-extra python3-setuptools && dnf clean all && npm i -g yarn
